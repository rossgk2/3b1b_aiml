...
\begin{document}
	...
	\begin{itemize}
		...
		\item Since we can add step functions together to get a ``bump'' function, we can add together smoothed out step functions to get a smoothed out bump function.
