...
\begin{document}
	...
	The weights of all neurons constitute the  \textit{parameters} of the network; the dials or knobs that we can tweak to adjust the network's behavior.
	...
	Since there's multiple layers in the network and multiple neurons in each layer, notating activation values and weights in full generality can be a litle complicated. Please see the \textbf{Everything in formulas} section of the [summary article](Overview\%20of\%20neural\%20networks.html) for this!
\end{document}