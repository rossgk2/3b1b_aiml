...
[^1]: The *weighted sum* of numbers $a_1, ..., a_N$ by numeric weights $w_1, ..., w_N$ is defined to be $w_1 a_1 + ... + w_N a_N$. We "weight" each number by one of the weights, and compute the sum of all such weighted numbers.
